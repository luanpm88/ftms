class Transfer < ActiveRecord::Base
  ...
  def is_upfront_expired
    self.upfront_valid_until.present? && self.upfront_valid_until < Time.now
  end
  ...
  def display_upfront_valid_until
    ...
    edit_url = link_helper.url_for(controller: "transfers", action: "edit_upfront_valid_until", id: self.id)
