  ...
  def self.datatable(params, user)
    ...
    @records.each do |item|
      ...
      itemz = [
              ...
              "[#{item.cache_group_id.to_s}][#{item.find_old_group_id}]"+'<div class="text-left"><strong>'+item.contact_link+"</strong></div>"+'<div class="text-left">'+item.html_info_line.html_safe+item.referrer_link+"</div>"+item.picture_link+item.display_not_added_stock(params[:not_added_books]),
              "",
              "",
              "",
              "",
      ...
      if item.statuses.include?("deleted") and item.find_old_group_id.present?
        item.find_related_contacts.each do |child|
          row = [
                  ...
                  "[#{child.cache_group_id.to_s}]"+'<div class="text-left re_merge"><strong class="label_name" val="'+child.name.unaccent.to_s+'">'+child.contact_link+"</strong></div>"+'<div class="text-left">'+child.html_info_line.html_safe+child.referrer_link+"</div>"+child.picture_link,              
                  "",
                  "",
                  "",
                  "",
