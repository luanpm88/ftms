...
class DeliveryDetailsControllerTest < ActionController::TestCase
  ...
  test "should create delivery_detail" do
    assert_difference('DeliveryDetail.count') do
      post :create, delivery_detail: { book_id: @delivery_detail.book_id, delivery_id: @delivery_detail.delivery_id, quantity: @delivery_detail.quantity }
    end
  ...
  test "should update delivery_detail" do
    patch :update, id: @delivery_detail, delivery_detail: { book_id: @delivery_detail.book_id, delivery_id: @delivery_detail.delivery_id, quantity: @delivery_detail.quantity }
    assert_redirected_to delivery_detail_path(assigns(:delivery_detail))
  end
