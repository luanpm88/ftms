...
class SeminarsControllerTest < ActionController::TestCase
  ...
  test "should create seminar" do
    assert_difference('Seminar.count') do
      post :create, seminar: { description: @seminar.description, name: @seminar.name, start_at: @seminar.start_at }
    end
  ...
  test "should update seminar" do
    patch :update, id: @seminar, seminar: { description: @seminar.description, name: @seminar.name, start_at: @seminar.start_at }
    assert_redirected_to seminar_path(assigns(:seminar))
  end
