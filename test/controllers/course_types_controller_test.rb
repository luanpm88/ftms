...
class CourseTypesControllerTest < ActionController::TestCase
  ...
  test "should create course_type" do
    assert_difference('CourseType.count') do
      post :create, course_type: { description: @course_type.description, name: @course_type.name, short_name: @course_type.short_name }
    end
  ...
  test "should update course_type" do
    patch :update, id: @course_type, course_type: { description: @course_type.description, name: @course_type.name, short_name: @course_type.short_name }
    assert_redirected_to course_type_path(assigns(:course_type))
  end
